...
public class ElementUtil {
	 ...
	 * @return
	 */
	public static WebElement waitForPresenceGetElement(WebDriver driver, By locator, int timeout ) {	
	 ...
	 * @return
	 */
	public static WebDriver pickBrowser(WebDriver driver, String browserName) {
		if (browserName.equals("chrome")) {
	...
	public static void verifyText(String actualText, String expectedText) {
		if (actualText.equals(expectedText)) {
			...
			System.out.println("Do the math! Text is not correct");
		}	
	}
