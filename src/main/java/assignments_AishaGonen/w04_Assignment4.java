...
public class w04_Assignment4 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		clickOn(driver, By.xpath("//input[@id='alertbtn']"));
		
		getAlertVerifyText(driver, "Hello Kral Shakir, share this practice page and share your knowledge");
